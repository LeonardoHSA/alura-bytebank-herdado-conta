...
class NumeroDaContaComparator implements Comparator<Conta>{
	...
	public int compare(Conta c1, Conta c2) {
		...
		return Integer.compare(c1.getNumero(), c2.getNumero()); // E essa substitui a de baixo
		
//		return c1.getNumero() - c2.getNumero(); // Essa linha substitui o trecho de código abaixo
